        ...
        <div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div class="relative flex grid items-center grid-cols-2 lg:grid-cols-3">
                <ul class="flex items-center hidden space-x-8 lg:flex">
                    <li>
                        <a href="https://sylnifty.com/?page_id=1394&lang=pt" aria-label="Product pricing" title="Blog" class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Blog</a>
                    </li>
                </ul>
    ...
    <div class="relative flex flex-col-reverse py-16 lg:py-0 lg:flex-col">
        <div class="w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl">
            <div class="mb-0 lg:max-w-lg lg:pr-8 xl:pr-6">
                <h2 class=" mb-5 font-sans text-3xl font-bold tracking-tight text-gray-200 sm:text-4xl sm:leading-none md:text-center">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <a href="https://www.instagram.com/sylniftyfeet/" class="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
                                <img style="filter: invert(75%);" src="{{  url('storage/icons')}}/instagram.png" width="25" alt="">
                            </a>
                        </div>
                        <div class="flex items-center">
                            <a href="https://www.facebook.com/syl.nifty" class="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
                                <img style="filter: invert(75%);" src="{{  url('storage/icons')}}/facebook.png" width="25" alt="">
                            </a>
                        </div>
                        <div class="flex items-center">
                            <a href="https://twitter.com/Syl_Nifty?t=XYrnpmotaZJTXn33dEHUdA&s=09" class="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
                                <img style="filter: invert(75%);" src="{{  url('storage/icons')}}/twitter.png" width="25" alt="">
                            </a>
                        </div>
                        <div class="flex items-center">
                            <a href="/" class="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
                                <img style="filter: invert(75%);" src="{{  url('storage/icons')}}/youtube.png" width="25" alt="">
                            </a>
                        </div>
                        <div class="flex items-center">
                            <a href="https://api.whatsapp.com/send?phone=5541997097495&text=Lady%20Syl%20Nifty" class="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">
                                <img style="filter: invert(75%);" src="{{  url('storage/icons')}}/whatsapp.png" width="25" alt="">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="inset-y-0 top-0 right-0 w-full max-w-xl px-4 mx-auto mb-6 md:px-0 lg:pl-8 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-1/2 lg:max-w-full lg:absolute xl:px-0">
            ...
            @foreach ($data['posts'] as $key => $item)
            @if ($key == 0)
            <img class="object-cover w-full h-56 rounded shadow-lg lg:rounded-none lg:shadow-none md:h-96 lg:h-full" src="{{ url('storage/Posts') }}/1.jpg" alt="" />
            @endif
            @endforeach
        </div>
    </div>
                        ...
                        <div class="relative bg-white rounded shadow-2xl p-7 sm:p-10">
                            ...
                            <form>
                                ...
                                <div class="mb-1 sm:mb-2">
                                    ...
                                    <textarea placeholder="seu comentário..." required="" class="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline" id="comment" name="comment"></textarea>
                                </div>
                                <div class="mt-4 mb-2 sm:mb-4">
                                    <button type="submit" class="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-black hover:bg-white hover:text-black focus:shadow-outline focus:outline-none">
                                        Enviar
                                    </button>
                                </div>
                            </form>
